...
def apply_icons_to_desktop():
    ...
    icons_dir   = os.path.normpath(os.path.join(_script_dir, "..", "Icons", "Midnight_Ooo"))
    ...
    persist_dir = os.path.join(appdata_local, "Icons_Engine", "Themes", "Ooo_Midnight")
