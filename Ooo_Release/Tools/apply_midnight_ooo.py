"""
Aplicador unificado de Isoform - Midnight Ooo.
Delega en ``Tools/icon_engine.py`` (raíz del repo).
Ejecuta con:  python apply_midnight_ooo.py
"""
import os
import sys
...
_CONFIG = os.path.join(_THEME_DIR, "theme_midnight_ooo.json")
